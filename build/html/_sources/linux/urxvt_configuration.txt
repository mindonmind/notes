...
参考
----
1. `urxvt man page <http://linux.die.net/man/1/urxvt>`_
2. `urxvt in arch wiki <https://wiki.archlinux.org/index.php/Urxvt#Scrollwheel_Support>`_
3. `urxvt in awesome wiki <http://awesome.naquadah.org/wiki/Urxvt>`_
